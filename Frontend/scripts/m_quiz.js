...
//   const quizContent = document.querySelector(".section").value;
  ...
  async function fetchQuiz() {
      ...
      const level = "MEDIUM"; // Example level
      const apiUrl = "https://cos1.vercel.app/api/quiz/";
      ...
      try {
          ...
          quizName.innerText = data.name;
        quizName2.innerText = data.name;
        ...
        submitButton.onclick = async () => {
          ...
          questions.forEach((question, index) => {
            ...
            if (
              selectedOption &&
              selectedOption.value == data.questions[index].correct
            ) {
              score++;
              // @ts-ignore
              ...
              const correctOption = /** @type {HTMLInputElement} */ (
                question.querySelector(
                  `input[value="${data.questions[index].correct}"]`
                )
              );
              /** @type {HTMLElement} */ (
